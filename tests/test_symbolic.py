...
from cualni_cryst.symbolic import do3_to_2h_pulled_metric, do3_to_6m_pulled_metric


def test_symbolic_6m_pulled_metric_structure():
    (_, a, b, c, beta), G, _ = do3_to_6m_pulled_metric()
...
def test_symbolic_2h_pulled_metric_structure():
    (_, a, b, c), G, _ = do3_to_2h_pulled_metric()
