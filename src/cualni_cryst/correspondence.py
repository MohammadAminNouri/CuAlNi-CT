...
class Correspondence:
    ...
    Internal convention used everywhere in this package:

        u_M = C_m_from_a @ u_A

    i.e. a parent/austenite crystallographic direction becomes a product/martensite
    crystallographic direction after lattice distortion.

    This is the action denoted C^{M→A} by Cayron (the superscript names the bases,
    not the intuitive mapping direction).  To avoid that notational trap, the Python
    attribute name always spells out the actual action.
    """
